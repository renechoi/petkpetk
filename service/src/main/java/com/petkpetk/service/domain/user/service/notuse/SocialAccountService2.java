...
//
// 	private final Map<String, OAuth2UserAccount> userInfoMap = new HashMap<>();
//
// 	@Autowired
...
// 		OAuth2UserAccount userInfo = userInfoMap.get(clientRegistrationId.toLowerCase());
//
// 		if (userInfo != null) {
// 			return userInfo.signup(oAuth2User);
// 		}
//
